...
par(mfcol=c(2,2))
plot(x= b$Date_Time, y= b$Global_active_power, col = "black", ylab = "Global Active Power (kilowatts)", xlab = "", type= "n")
lines(x= b$Date_Time, y= b$Global_active_power, type = "l")
...
plot(x= b$Date_Time, y= b$Voltage, col = "black", ylab = "Voltage", xlab = "datetime", type= "n")
lines(x= b$Date_Time, y= b$Voltage, type = "l")

plot(x= b$Date_Time, y= b$Global_reactive_power, col = "black", ylab = "Global_reactive_power", xlab = "datetime", type= "n")
lines(x= b$Date_Time, y= b$Global_reactive_power, type = "l")
